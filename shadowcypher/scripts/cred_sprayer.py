...
Usage:
    python3 cred_sprayer.py -t TARGET -s SERVICE [-u USER] [-U USERLIST] [-P PASSLIST]

Examples:
    python3 cred_sprayer.py -t 192.168.1.1 -s ssh -U users.txt -P passwords.txt
...
def main():
    p = argparse.ArgumentParser(description="ShadowCypher Credential Sprayer")
