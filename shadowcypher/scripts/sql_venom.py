#!/usr/bin/env python3
"""
SHADOWCYPHER // SQL VENOM — SQL Injection Scanner & Exploiter
...
Usage:
    python3 sql_venom.py -u "http://target.com/page?id=1" [-p id] [--dump] [--dbs]
"""
...
def main():
    p = argparse.ArgumentParser(description="ShadowCypher SQL Venom — SQLi Scanner")
    ...
    print(f"\n{C['B']}{'='*70}{C['N']}")
    print(f" {C['C']}SHADOWCYPHER // SQL VENOM{C['N']}")
    print(f"{C['B']}{'='*70}{C['N']}")
