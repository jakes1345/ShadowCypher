...
class Logger:
    ...
    def set_mission_context(self, mission_id: Optional[str]) -> None:
    ...
    def log(self, level: str, module: str, message: str, **extra: Any) -> None:
    ...
    def warn(self, module: str, message: str, **extra: Any) -> None:
