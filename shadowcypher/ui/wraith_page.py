...
class WraithProtocol(BasePage):
    ...
    def __init__(self):
        ...
        bx1.set_margin_start(10); bx1.set_margin_end(10); bx1.set_margin_top(10); bx1.set_margin_bottom(10)
        lbl1 = Gtk.Label(xalign=0); lbl1.set_line_wrap(True)
        lbl1.set_markup(
        ...
        frm1.add(bx1); self.workspace.pack_start(frm1, False, False, 0)

        # Kill All Tunnels
        frm2 = Gtk.Frame(label="TUNNEL TERMINATION")
        bx2 = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=10)
        bx2.set_margin_start(10); bx2.set_margin_end(10); bx2.set_margin_top(10); bx2.set_margin_bottom(10)
        ...
        frm2.add(bx2); self.workspace.pack_start(frm2, False, False, 0)
        ...
        frm3.add(bx3); self.workspace.pack_start(frm3, False, False, 0)
        ...
        bx_fp.set_margin_start(10); bx_fp.set_margin_end(10); bx_fp.set_margin_top(10); bx_fp.set_margin_bottom(10)
        fp = hardener.get_hardware_footprint()
        lbl_fp = Gtk.Label(); lbl_fp.set_line_wrap(True); lbl_fp.set_xalign(0)
        lbl_fp.set_markup(f"<span size='small' color='#64748b'>MASTER_FP:\n{fp[:32]}...\n{fp[32:]}</span>")
        bx_fp.pack_start(lbl_fp, False, False, 0)
        frm_fp.add(bx_fp); self.intel_sidebar.pack_start(frm_fp, False, False, 0)
