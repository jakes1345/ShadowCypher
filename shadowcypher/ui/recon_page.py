"""Recon page — nmap-based service discovery UI."""
...
class ReconPage(BasePage):
    """Recon UI — nmap-based service and port discovery."""

    def __init__(self):
        super().__init__("\U0001f4e1 Recon")
    ...
    def _build_ui(self):
        ...
        self.btn_inspect = Gtk.Button(label="Scan")
    ...
    def _on_inspect_clicked(self, btn):
        ...
        self.terminal.log(f"Scanning {target}...", "RECON")
